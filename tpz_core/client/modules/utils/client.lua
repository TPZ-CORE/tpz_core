...
Citizen.CreateThread(function()
	...
	function core.utils.loadGameData(name, waiter)
	...
	function core.utils.releaseGameData(name)
		local model = (type(name) == "string") and joaat(name) or name
		if IsModelValid(model) then
	...
	function core.utils.waiter(cb, maxDuration, loopTimer)
	...
	function core.utils.screenToWorld(distance, flags, toIgnore, mouseX, mouseY)
