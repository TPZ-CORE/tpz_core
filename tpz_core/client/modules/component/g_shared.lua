...
Citizen.CreateThread(function()
  ...
  function core.component.getFullPedComponentList()
    if playerComponentsData then return playerComponentsData end
    playerComponentsData = core.file.load("component.data.playerComponents")
  ...
  function core.component.getFullHorseComponentList()
    if horseComponentsData then return horseComponentsData end
    horseComponentsData = core.file.load("component.data.horseComponents")
  ...
  function core.component.getCategoryHash(category)
  ...
  function core.component.getHeadFromSkinTone(ped, headIndex, skinTone)
  ...
  function core.component.getBodiesLowerFromSkinTone(ped, bodiesIndex, skinTone)
    local ped = ped or PlayerPedId()
    local sex = "M"
    if type(ped) == "string" then
      sex = (ped == "mp_male") and "M" or "F"
  ...
  function core.component.getBodiesUpperFromSkinTone(ped, bodiesIndex, skinTone)
    local ped = ped or PlayerPedId()
    local sex = "M"
    if type(ped) == "string" then
      sex = (ped == "mp_male") and "M" or "F"
  ...
  function core.component.getEyesFromIndex(ped, index)
    local ped = ped or PlayerPedId()
    local sex = "M"
    if type(ped) == "string" then
      sex = (ped == "mp_male") and "M" or "F"
  ...
  function core.component.getTeethFromIndex(ped, index)
    local ped = ped or PlayerPedId()
    local sex = "M"
    if type(ped) == "string" then
      sex = (ped == "mp_male") and "M" or "F"
  ...
  core.SetModuleLoaded('component')
