...
Citizen.CreateThread(function()
  ...
  ---@return TimeoutClass (Return the timeout instance)
  function core.timeout.set(msec, cb, ...)
  ...
  ---@param ... any (Additional arguments to pass to the callback function)
  ---@return TimeoutClass (Return the timeout instance)
  function core.timeout.loop(msec, cb, ...)
    local args = table.pack(...)
    local t = TimeoutClass:set(msec, cb, args)
  ...
  ---@param ... any (Additional arguments to pass to the callback function)
  ---@return TimeoutClass (Return the timeout instance)
  function core.timeout.delay(id, msec, cb, ...)
    if delays[id] then
      delays[id]:clear()
      delays[id] = nil
    end
    delays[id] = core.timeout.set(msec, cb, ...)
    delays[id].id = id
    return delays[id]
  end
  ...
  ---@param ... any (Additional arguments to pass to the callback function)
  ---@return TimeoutClass (Return the timeout instance)
  function core.timeout.noSpam(id, msec, cb, ...)
    if delays[id] then
      delays[id]:clear()
      delays[id] = nil
      delays[id] = core.timeout.set(msec, cb, ...)
      ...
      delays[id] = core.timeout.set(msec, function() end)
      delays[id].id = id
      cb(...)
      return delays[id]
    end
