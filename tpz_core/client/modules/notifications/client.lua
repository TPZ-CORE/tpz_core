...
Citizen.CreateThread(function()
  ...
  core.notifications.NotifyLeft = function(title, subtitle, dict, icon, duration, color)
      ...
      core.functions.LoadTexture(dict)
      ...
      structData:SetInt64(8 * 1, core.functions.BigInt(CreateVarString(10, "LITERAL_STRING", title)))
      structData:SetInt64(8 * 2, core.functions.BigInt(CreateVarString(10, "LITERAL_STRING", subtitle)))
      structData:SetInt32(8 * 3, 0)
      structData:SetInt64(8 * 4, core.functions.BigInt(GetHashKey(dict)))
      structData:SetInt64(8 * 5, core.functions.BigInt(GetHashKey(icon)))
      structData:SetInt64(8 * 6, core.functions.BigInt(GetHashKey(color or "COLOR_WHITE")))
  ...
  core.notifications.NotifyTip = function(tipMessage, duration)
      ...
      structData:SetUint64(8 * 1, core.functions.BigInt(CreateVarString(10, "LITERAL_STRING", tipMessage)))
  ...
  core.notifications.NotifyTop = function(message, location, duration)
      ...
      structData:SetInt64(8 * 1, core.functions.BigInt(CreateVarString(10, "LITERAL_STRING", location)))
      structData:SetInt64(8 * 2, core.functions.BigInt(CreateVarString(10, "LITERAL_STRING", message)))
  ...
  core.notifications.NotifyRightTip = function(tipMessage, duration)
      ...
      local structData = DataView.ArrayBuffer(8 * 3)
      structData:SetInt64(8 * 1, core.functions.BigInt(CreateVarString(10, "LITERAL_STRING", tipMessage)))
  ...
  core.notifications.NotifyObjective = function(message, duration)
      ...
      structData:SetInt64(8 * 1, core.functions.BigInt(strMessage))
  ...
  core.notifications.NotifyAvanced = function(text, dict, icon, text_color, duration, quality, showquality)
      ...
      local structConfig = DataView.ArrayBuffer(8 * 7)
      structConfig:SetInt32(8 * 0, tonumber(duration or 3000))
      structConfig:SetInt64(8 * 1, core.functions.BigInt(CreateVarString(10, "LITERAL_STRING", "Transaction_Feed_Sounds")))
      structConfig:SetInt64(8 * 2, core.functions.BigInt(CreateVarString(10, "LITERAL_STRING", "Transaction_Positive")))
    
      local structData = DataView.ArrayBuffer(8 * 10)
      structData:SetInt64(8 * 1, core.functions.BigInt(CreateVarString(10, "LITERAL_STRING", text)))
      structData:SetInt64(8 * 2, core.functions.BigInt(CreateVarString(10, "LITERAL_STRING", dict)))
      structData:SetInt64(8 * 3, core.functions.BigInt(GetHashKey(icon)))
      structData:SetInt64(8 * 5, core.functions.BigInt(GetHashKey(text_color or "COLOR_WHITE")))
  ...
  core.notifications.NotifyCenter = function(text, duration, text_color)
      ...
      structData:SetInt64(8 * 1, core.functions.BigInt(CreateVarString(10, "LITERAL_STRING", text)))
      structData:SetInt64(8 * 2, core.functions.BigInt(GetHashKey(text_color or "COLOR_PURE_WHITE")))
  ...
  core.notifications.NotifyDead = function(title, audioRef, audioName, duration)
      ...
      local structData = DataView.ArrayBuffer(8 * 9)
      structData:SetInt64(8 * 1, core.functions.BigInt(CreateVarString(10, "LITERAL_STRING", title)))
      structData:SetInt64(8 * 2, core.functions.BigInt(CreateVarString(10, "LITERAL_STRING", audioRef)))
      structData:SetInt64(8 * 3, core.functions.BigInt(CreateVarString(10, "LITERAL_STRING", audioName)))
  ...
  core.notifications.NotifyWarning = function(title, message, audioRef, audioName, duration)
      ...
      structData:SetInt64(8 * 1, core.functions.BigInt(CreateVarString(10, "LITERAL_STRING", title)))
      structData:SetInt64(8 * 2, core.functions.BigInt(CreateVarString(10, "LITERAL_STRING", message)))
      structData:SetInt64(8 * 3, core.functions.BigInt(CreateVarString(10, "LITERAL_STRING", audioRef)))
      structData:SetInt64(8 * 4, core.functions.BigInt(CreateVarString(10, "LITERAL_STRING", audioName)))
  ...
  core.notifications.NotifyLeftRank = function(title, subtitle, dict1, texture, duration, color)
      ...
      core.functions.LoadTexture(dict1)
      ...
      struct2:SetInt64(8 * 1, core.functions.BigInt(string1))
      struct2:SetInt64(8 * 2, core.functions.BigInt(string2))
      struct2:SetInt64(8 * 4, core.functions.BigInt(dict))
      struct2:SetInt64(8 * 5, core.functions.BigInt(texture))
      struct2:SetInt64(8 * 6, core.functions.BigInt(GetHashKey(color or "COLOR_WHITE")))
  ...
  core.SetModuleLoaded("notifications")
end)
