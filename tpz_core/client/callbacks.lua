...
function ClientRPC:TriggerRpcAsync(...)
    ...
    TriggerServerEvent("tpz_core:TriggerServerCallback", self.name, self.uniqueId, false, ...)
...
function ClientRPC:TriggerRpcAwait(...)
    ...
    TriggerServerEvent("tpz_core:TriggerServerCallback", self.name, self.uniqueId, true, ...)
...
RegisterNetEvent('tpz_core:ServerCallback', ClientRPC.ExecuteRpc)
...
AddEventHandler('tpz_core:ExecuteServerCallBack', ClientRPC.Callback.TriggerAsync)
...
function ClientRPC:Trigger(uniqueId, isSync, ...)
    ...
    self._callback(function(...)
        TriggerServerEvent("tpz_core:ServerCallback", uniqueId, isSync, ...)
    end, ...)
end
