local TOKEN = 0 -- REPLACE 0 TO THE DESIRED BOT TOKEN. 
...
function GetUserDiscordRoles(user, guild --[[optional]])
    local discordId = nil
    ...
    local roles = nil
      ...
      if discordId then
          ...
          print("WARNING: Discord was not connected to user's RedM account...")
          return false
      end
      return false
end
